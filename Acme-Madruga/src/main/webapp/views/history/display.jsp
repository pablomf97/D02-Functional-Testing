...
<jstl:choose>
		...
		<table class="displayStyle">
			...
			<tr>
				...
				<jstl:if test="${!linkRecords.isEmpty()}">
					...
					<td><a href="linkRecord/list.do?historyId=${history.id}">
							<spring:message code="history.linkRecord.list" />
					</a></td>
				</jstl:if>
	...
	<jstl:otherwise>
		...
		<tr>
			<td><h3>
					<strong><spring:message
							code="history.miscellaneousRecords" />: </strong>
				</h3></td>
			<jstl:if test="${!miscellaneousRecords.isEmpty() }">
		...
		<tr>
			<td><h3>
					<strong><spring:message code="history.periodRecords" />:
					</strong>
				</h3></td>
