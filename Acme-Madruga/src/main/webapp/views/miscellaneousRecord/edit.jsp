...
<security:authorize access="hasRole('BROTHERHOOD')">
	...
	<form:form modelAttribute="miscellaneousRecord"
		action="miscellaneousRecord/edit.do" id="form">
		...
		<spring:message code="miscellaneousRecord.description" />
		<br>
		<form:textarea code="miscallenousRecord.description"
			path="description" />
		...
		<acme:cancel url="miscellaneousRecord/list.do?historyId=${historyId}"
		...
		<jstl:if test="${miscellaneousRecord.id != 0}">
			<acme:delete name="delete" confirmation="mr.confirm.delete"
				code="miscellaneousRecord.delete" />
			<br />
			<br />
		</jstl:if>
