...
<form:form action="chapter/edit.do" modelAttribute="chapterForm"
	methodParam="post"
	...
	<form:input path="surname" value="${chapter.surname}" />
	...
	<form:input path="name" value="${chapter.name}" />
	...
	<form:input path="middleName" value="${chapter.middleName}" />
	...
	<form:input path="email" value="${chapter.email}" id="email" />
	...
	<form:input path="photo" value="${chapter.photo}" />
	...
	<form:input path="phoneNumber" value="${chapter.phoneNumber}"
		id="phoneNumber" />
	...
	<form:input path="title" value="${chapter.title}" id="title" />
	<form:errors cssClass="error" path="title" />
	<br>


	<jstl:if test="${empty chapter.zone}">
		<form:label path="zone">
			<spring:message code="chapter.zone" />:</form:label>
