...
public class SegmentServiceTest extends AbstractTest {
	 ...
	 * 
	 * 
	 * Coverage of the total project (lines of codes): 1866
	 */
	...
	public void driver() {
		Object testingData[][] = {
				...
				{ "brotherhood1", "segment3", "save",
						IllegalArgumentException.class },// brotherhood trying
															// to save not own
															// segemnt.
				{ null, "segment1", "save", IllegalArgumentException.class },// Non
																				// authenticated
				{ "brotherhood2", "segment3", "delete", null },// Positive
				{ "brotherhood1", "segment3", "delete",
						IllegalArgumentException.class },// brotherhood trying
															// to delete not own
															// segemnt.
				{ "brotherhood1", "segment1", "delete",
						IllegalArgumentException.class },// Intenta eliminar un
															// segment cuyo
															// iSeditable=false
				{ "brotherhood1", "segment1", "editNegative",
						IllegalArgumentException.class },// Va a intentar editar
															// un segment que no
															// es editable, peta
				{ "brotherhood1", "segment2", "editPositive", null } // positive
																		// edit
	...
	protected void template(String username, int segmentId,
		...
		try {
			if (currentOperation.equals("save")) {
				...
				segment.setExpectedTimeDestination(sdf
						.parse("05/09/2021 12:00"));
	...
	public void driver2() {
		...
		Object testingData[][] = {
				...
				{ "brotherhood1", "05/09/2021 12:00", "05/09/2021 14:00",
						"parade1", -21.2, 14.6, 30.5, 40.4, false, "save", null },// Positive
				{ "brotherhood1", "05/09/2021 12:00", "05/09/2021 14:00",
						"parade1", 12.2, 13.6, 30.5, 40.4, false, "save",
						IllegalArgumentException.class },// longitud y latitud
															// de origen no
															// coincide cno
															// elultimo segment,
															// debe petear.
				{ "brotherhood1", "05/09/2021 12:00", "05/09/2021 10:00",
						"parade1", -21.2, 14.6, 30.5, 40.4, false, "save",
						IllegalArgumentException.class } // la hora de inicio es
															// posterior a la de
															// fin debe petar
		...
		for (int i = 0; i < testingData.length; i++) {
			template2((String) testingData[i][0], (String) testingData[i][1],
					(String) testingData[i][2],
					(int) super.getEntityId((String) testingData[i][3]),
					(Double) testingData[i][4], (Double) testingData[i][5],
					(Double) testingData[i][6], (Double) testingData[i][7],
					(boolean) testingData[i][8], (String) testingData[i][9],
					(Class<?>) testingData[i][10]);

		}
	}

	protected void template2(String username, String originDate,
			String destinationDate, int paradeId, Double originLatitude,
			Double originLongitude, Double destinationLatitude,
			Double destinationLongitude, boolean isEditable,
			String currentOperation, Class<?> expected) {
