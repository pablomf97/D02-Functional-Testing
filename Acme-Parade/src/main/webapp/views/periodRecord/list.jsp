...
<security:authorize access="hasRole('BROTHERHOOD')">
	...
	<display:table pagesize="10" class="displaytag"
		name="periodRecords"
		requestURI="periodRecord/list.do?historyId=${historyId}" id="row">

		<display:column titleKey="periodRecord.title">
			<jstl:out value="${row.title}"></jstl:out>
		</display:column>

		<display:column titleKey="periodRecord.display">
			<a
				href="periodRecord/display.do?periodRecordId=${row.id}">
				<spring:message code="miscellaneousRecord.display" />
			</a>
		</display:column>
	</display:table>

	<a href="periodRecord/create.do"> <spring:message
